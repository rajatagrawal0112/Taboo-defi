import { ChainId, JSBI, Percent, Token, WETH } from 'quest-taboo-sdk'
import { fortmatic, injected, lattice, portis, torus, trustwallet, walletconnect, walletlink } from '../connectors'
...
export const TABOO: ChainTokenMap = {
    [ChainId.MAINNET]: new Token(
        ChainId.MAINNET,
...
export const xTABOO: ChainTokenMap = {
    [ChainId.MAINNET]: new Token(
        ChainId.MAINNET,
