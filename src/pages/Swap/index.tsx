...
import { ChainId, CurrencyAmount, JSBI, Token, Trade } from 'quest-taboo-sdk'
...
export default function Swap() {
    ...
    return (
        <>
            <Helmet>
                <title>{i18n._(t`Swap`)} | TabooSwap</title>
                <meta
                    name="description"
                    content="Taboo allows for swapping of ERC20 compatible tokens across multiple networks"
                />
            </Helmet>
            <TokenWarningModal
