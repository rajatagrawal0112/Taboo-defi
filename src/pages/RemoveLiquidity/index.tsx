...
import { ChainId, Currency, ETHER, Percent, WETH, currencyEquals } from 'quest-taboo-sdk'
...
export default function RemoveLiquidity({
            ...
            <>
                <RowBetween>
                    <Text color={theme.text2} fontWeight={500} fontSize={16}>
                        {i18n._(t`TABOO ${currencyA?.getSymbol(chainId)}/${currencyB?.getSymbol(chainId)} Burned`)}
                    </Text>
                    <RowFixed>
    ...
    return (
        <>
            <Helmet>
                <title>{i18n._(t`Remove Liquidity`)} | TabooSwap</title>
            </Helmet>
