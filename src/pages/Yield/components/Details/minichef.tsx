...
import { Token, WETH } from 'quest-taboo-sdk'
...
export default function InputGroup({
    ...
    const [approvalState, approve] = useApproveCallback(
        ...
        '0x97925566b8650E2Df915e4AC730Da1960a7CC0a2' //miniChef on Rinkeby
    )
            ...
            <div className="flex flex-col space-y-4 py-6">
                {pending && Number(pending) > 0 && (
                    <div className=" px-4">
                        ...
                        >
                            <Trans>
                                Harvest {formattedNum(pending)} TABOO & {formattedNum(reward)} ETH
                            </Trans>
                        </Button>
                    </div>
                )}
