            ...
            <div className="flex flex-wrap">
                <div className="flex flex-col flex-grow md:mb-14">
                    ...
                    <div className="flex items-center">
                        <img className="w-10 md:w-16 -ml-1 mr-1 md:mr-2 -mb-1.5" src={XSushiImage} alt="taboo" />
                        <div className="flex flex-col justify-center">
                            <p className="text-caption2 md:text-lg font-bold text-high-emphesis">
                                {formatFromBalance(xSushiBalance.value)}
                            </p>
                            <p className="text-caption2 md:text-caption text-primary">xTABOO</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col flex-grow">
                    ...
                    <div className="flex items-center ml-8 md:ml-0">
                        ...
                        <div className="flex flex-col justify-center">
                            ...
                            <p className="text-caption2 md:text-caption text-primary">TABOO</p>
                        </div>
                    </div>
                </div>
