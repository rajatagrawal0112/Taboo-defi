    ...
    return (
        <Modal isOpen={networkModalOpen} onDismiss={toggleNetworkModal}>
            ...
            <div className="text-lg text-primary mb-6">
                You are currently browsing <span className="font-bold text-pink">TabooSwap</span>
            ...
            <div className="flex flex-col space-y-5 overflow-y-auto">
                {[
                    ...
                    return (
                        ...
                        >
                            <img src={NETWORK_ICON[key]} alt="Taboo Network" className="rounded-md mr-2 w-8 h-8" />
                            <div className="text-primary font-bold">{NETWORK_LABEL[key]}</div>
                        </button>
                    )
                })}
