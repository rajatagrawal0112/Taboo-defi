...
function Routes(): JSX.Element {
    ...
    return (
        <Switch>
            ...
            {chainId === ChainId.ROPSTEN && <Route exact strict path="/yield" component={Yield} />}
            ...
            {/* SushiBar Staking */}
            {(chainId === ChainId.MAINNET || chainId === ChainId.MATIC || chainId === ChainId.RINKEBY || chainId === ChainId.ROPSTEN || chainId === ChainId.BSC) && ( 
            <Route exact strict path="/taboobar" component={SushiBar} />
            )}
            {(chainId === ChainId.MAINNET || chainId === ChainId.MATIC || chainId === ChainId.RINKEBY || chainId === ChainId.ROPSTEN || chainId === ChainId.BSC) && (
                <Route exact strict path="/taboobar/transactions" component={SushiBarTransactions} />
            )}
            {(chainId === ChainId.MAINNET || chainId === ChainId.MATIC || chainId === ChainId.RINKEBY || chainId === ChainId.ROPSTEN || chainId === ChainId.BSC) && ( 
            <Route exact strict path="/taboobar/tips" component={SushiBarTips} />
            )}
            {(chainId === ChainId.MAINNET || chainId === ChainId.MATIC || chainId === ChainId.RINKEBY || chainId === ChainId.ROPSTEN || chainId === ChainId.BSC) && ( 
