import { ChainId, CurrencyAmount, JSBI, Pair, Token, TokenAmount, WETH } from 'quest-taboo-sdk'
import useCurrentBlockTimestamp from 'hooks/useCurrentBlockTimestamp'
import { useMemo } from 'react'
import { DAI, SUSHI, USDC, USDT, WBTC ,TABOO} from '../../constants'
...
export function useStakingInfo(pairToFilterBy?: Pair | null): StakingInfo[] {
    ...
    const uni = chainId ? TABOO[chainId] : undefined 
