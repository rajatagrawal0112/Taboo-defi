...
export function useMasterChefV2Contract(withSignerIfPossible?: boolean): Contract | null {
    ...
    if (chainId) {
        switch (chainId) {
            case ChainId.ROPSTEN:  // earlier it was MAINNET
                address = '0x97925566b8650E2Df915e4AC730Da1960a7CC0a2' // This was placed earlier 0xEF0881eC094552b2e128Cf945EF17a6752B4Ec5d
                break
        }
    }
...
export function useMiniChefV2Contract(withSignerIfPossible?: boolean): Contract | null {
    ...
    if (chainId) {
        switch (chainId) {
            case ChainId.ROPSTEN:
                address = '0x97925566b8650E2Df915e4AC730Da1960a7CC0a2'
                break
        }
    }
